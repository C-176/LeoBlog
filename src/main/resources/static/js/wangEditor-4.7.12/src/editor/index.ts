...
import initFullScreen, {setFullScreen, setUnFullScreen} from './init-fns/set-full-screen'
...
import initPlugins, {pluginsListType, RegisterOptions, registerPlugin} from '../plugins'
